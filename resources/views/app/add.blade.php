...
@section('content')
    @component('components.breadcrumb')
        ...
        @slot('title') Add Aplication @endslot
    @endcomponent
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" method="POST" action="{{ url('app_simpan') }}" enctype="multipart/form-data">
					  @csrf
                        <div>
                            <div class="row">
                                <div class="col-xl-6">
							...
							<div class="row">
								...
								<div class="col-xl-4">
                                    <div class="mb-3">
                                        <label for="cleave-date" class="form-label">Icon</label>
							...
							<div class="row">
								<div class="col-xl-4">
									<div class="mb-3">
										...
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio" name="is_newtab" id="defaultYes" value="1" checked>
											<label class="form-check-label" for="defaultYes">Yes</label>
										</div>
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio" name="is_newtab" id="defaultNo" value="0">
								...
								<div class="col-xl-4">
									<div class="mb-3">
										...
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio" name="is_internal" id="defaultYes" value="1" checked>
											<label class="form-check-label" for="defaultYes">Yes</label>
										</div>
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio" name="is_internal" id="defaultNo" value="0">
											<label class="form-check-label" for="defaultNo">No</label>
										</div>
									</div>
								</div>
								<div class="col-xl-4">
									<div class="mb-3">
										...
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio" name="is_active" id="defaultYes" value="1" checked>
											<label class="form-check-label" for="defaultYes">Yes</label>
										</div>
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio" name="is_active" id="defaultNo" value="0">
											<label class="form-check-label" for="defaultNo">No</label>
										</div>
									</div>
								</div>
